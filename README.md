...
1. n8n runs every morning at 9:00 AM.
2. n8n connects to MySQL database.
3. SQL query fetches open and partially paid AP invoices.
4. SQL calculates outstanding amount, overdue days, aging bucket, and priority.
5. n8n converts the SQL result into a report file.
6. n8n emails the AP aging report to the finance team.
...
4. Upload `n8n/ap_aging_n8n_workflow.json`.
5. Add your MySQL and Gmail/SMTP credentials.
